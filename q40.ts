...
line includes a value for the number of tracks, add that value to 
the album’s Object. Make at least one new function call that includes the 
...
return title;
 ...
 console.log(make_album("Arjit Singh","Barish"));
 console.log(make_album("Pink Floyd", "The Dark Side of the Moon"));
 console.log(make_album("Kendrick Lamar", "DAMN.", 14));